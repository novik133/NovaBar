...
namespace Settings {
    ...
    public class SettingsWindow : Gtk.Window {
        ...
        private Gtk.Widget create_about_tab() {
            ...
            var version_label = new Gtk.Label("Version 0.1.2");
            ...
            // Support section
            var support_box = new Gtk.Box(Gtk.Orientation.VERTICAL, 8);
            support_box.margin_top = 16;
            
            var support_label = new Gtk.Label("If you like this program, consider supporting me:");
            support_label.get_style_context().add_class("dim-label");
            support_box.pack_start(support_label, false, false, 0);
            
            var kofi_btn = new Gtk.LinkButton.with_label("https://ko-fi.com/novadesktop", "☕ Support on Ko-fi");
            kofi_btn.get_style_context().add_class("suggested-action");
            support_box.pack_start(kofi_btn, false, false, 0);
            
            box.pack_start(support_box, false, false, 0);
            
            // Copyright and license
            var copyright = new Gtk.Label("© 2025-2026 Kamil Nowicki");
